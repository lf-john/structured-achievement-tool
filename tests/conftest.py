...
def mock_default_api_tools():
    ...
    """
    with patch('default_api.run_shell_command') as mock_run_shell_command,\
         ...
         patch('default_api.activate_skill') as mock_activate_skill:        # Configure default return values for mocks if necessary
