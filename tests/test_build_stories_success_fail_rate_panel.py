...
class TestStoriesSuccessFailRatePanel:
    ...
    def test_panel_with_grid_position(self):
        ...
        panel = builder.create_stories_success_fail_panel(grid_pos={"x": 0, "y": 0, "w": 12, "h": 8})
    ...
    def test_panel_with_min_max(self):
        ...
        panel = builder.create_stories_success_fail_panel(yaxis_min=0, yaxis_max=100)
    ...
    def test_panel_with_time_range(self):
        ...
        panel = builder.create_stories_success_fail_panel(time_range={"from": "now-24h", "to": "now"})
